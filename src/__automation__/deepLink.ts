 ...
 *   nexus://memory?cmd=snap::<label>
 *   nexus://memory?cmd=clear::snapshots
 *   nexus://tts?cmd=download::<engine>
 *   nexus://tts?cmd=synthesize::<engine>
 *   nexus://tts?cmd=release
 *   nexus://e2e/benchmark   (Android: cold-launch path lives in
...
export async function dispatchAutomationDeepLink(
  ...
  // nexus://e2e/benchmark — bench host. Match against the raw URL via
