/**
 * Parser for the `nexus://hub/run` deep link.
 *
...
/**
 * True only for the exact `nexus://hub/run` route (host=hub, path=run),
...
/**
 * Parses and validates a `nexus://hub/run?repo_id=…&filename=…&source=…`
