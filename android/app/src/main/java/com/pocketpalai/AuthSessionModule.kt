...
class AuthSessionModule(reactContext: ReactApplicationContext) :
   ...
   * in-flight promise; any other nexus:// intent (e.g. host=hub) falls
  ...
  private companion object {
    // Host segment of the checkout callback (nexus://checkout/*). Other
    // nexus:// hosts (e.g. hub) are not the checkout return.
