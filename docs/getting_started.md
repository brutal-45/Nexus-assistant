...
### Available Models
Nexus comes pre-configured with some popular SLMs:
...
To keep the device running smoothly, Nexus can automatically manage memory usage:
...
**Developers**: Nexus is built using React Native. Finding an easy solution that balances text selection with preserved formatting (especially Markdown support) has been tricky for me. If you have experience in this area, I’d love to hear from you!
